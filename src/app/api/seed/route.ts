...
import { categories, laws, lawTags } from '@/lib/seed-data'
import { lawyers, docTemplates } from '@/lib/lawyers-templates-data'

// POST /api/seed — seeds the database with initial data (idempotent)
