...
const CITIES = [
  ...
  { en: 'Rawalpindi', ur: 'راولپنڈی', value: 'Rawalpindi' },
  ...
  { en: 'Gujranwala', ur: 'گوجرانوالہ', value: 'Gujranwala' },
  { en: 'Sialkot', ur: 'سیالکوٹ', value: 'Sialkot' },
  { en: 'Hyderabad', ur: 'حیدرآباد', value: 'Hyderabad' },
  { en: 'Bahawalpur', ur: 'بہاولپور', value: 'Bahawalpur' },
  { en: 'Sukkur', ur: 'سکھر', value: 'Sukkur' },
  { en: 'Mardan', ur: 'مردان', value: 'Mardan' },
  { en: 'Abbottabad', ur: 'ایبٹ آباد', value: 'Abbottabad' },
]
...
const SPECIALIZATIONS = [
  ...
  { en: 'Property & Land', ur: 'جائداد و اراضی', value: 'property-land-law' },
  { en: 'Corporate & Company', ur: 'کارپوریٹ و کمپنی', value: 'corporate-company-law' },
  { en: 'Banking & Finance', ur: 'بینکنگ و مالیات', value: 'banking-finance-law' },
  { en: 'Tax Law', ur: 'ٹیکس قانون', value: 'tax-law' },
  { en: 'Customs & Trade', ur: 'کسٹمز و بین الاقوامی تجارت', value: 'customs-international-trade' },
  { en: 'Cyber & IT', ur: 'سائبر و آئی ٹی', value: 'cyber-it-law' },
  { en: 'Labor & Employment', ur: 'محنت و ملازمت', value: 'labor-employment-law' },
  { en: 'Human Rights', ur: 'انسانی حقوق', value: 'human-rights-minority-law' },
